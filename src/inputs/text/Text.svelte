<script lang="ts">
  ...
  let field: TextController | undefined;
  let errors: string[] = [];
...
<style>
  ...
  .input-container {
    ...
    row-gap: var(--label-input-row-gap, 0);
    justify-items: center;
    align-items: center;
    border: 2px solid transparent;
    transition: border var(--transition-duration);
    padding: var(--text-input-padding, var(--input-padding, 0.15rem 0.75rem));
